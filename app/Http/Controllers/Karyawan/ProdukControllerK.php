...
class ProdukControllerK extends Controller
{
    public function index()
    {
        ...
        return view('karyawan.produk.index', compact('produks', 'offset'));
    }
    ...
    public function create()
    {
        ...
        $brands = Brand::all();
        $jeniss = Jenis::all();
        return view('karyawan.produk.create', compact('kategoris', 'brands','suppliers', 'jeniss'));
    }
    ...
    public function store(IsiProdukFormRequest $request)
    {
        ...
        return redirect('karyawan/produk')->with('message', 'Produk berhasil ditambahkan');
    }
    ...
    public function edit(Produk $produk)
    {
        ...
        // dd($selectedSupplier);
        return view('karyawan.produk.edit', compact('produk', 'kategoris', 'suppliers', 'brands','selectedSupplier', 'jeniss', 'jenisProduk'));
    }
    ...
    public function update(IsiProdukFormRequest $request, $id)
    {
        ...
        if ($produk) {
            ...
            return redirect('karyawan/produk')->with('message', 'Produk berhasil diupdate');
        } else {
