<div class="container kasir">
    <div class="product mt-3 rounded">
        <div class="mt-2">
        ...
        <div class="product-header">
            ...
            <div class="search-kasir">
                <form action="">
                    <input type="search" wire:model.live="search" id="search" name="search" placeholder="Search . . ." autocomplete="off">
    ...
    <div class="checkout mt-3">
        ...
        @empty
            <div class="checkout-item my-1 text-center">
                <div>
