        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="tableReportPenjualan" class="display table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        @foreach ($reportPenjualans as $reportPenjualan)
                            <tr>
                                <td>{{ $reportPenjualan->tanggal }}</td>
                                <td>{{ $reportPenjualan->jumlah_penjualan }}</td>
                                <td>Rp {{ number_format($reportPenjualan->total_penjualan, 0, '.', '.') }}</td>
                                @php
                                    $totalPenjualan += $reportPenjualan->total_penjualan;
                                @endphp
                            </tr>
                        @endforeach
                        {{-- <tr>
                ...
                @push('tableJs')
                    <script>
                        ...
                        $(document).ready( function () {
                            ...
                            // Menggabungkan sel untuk Total Penjualan
                            cellToMerge.node().colSpan = colCount;

                            // Menambahkan CSS untuk mengganti warna latar belakang sel Total Penjualan
