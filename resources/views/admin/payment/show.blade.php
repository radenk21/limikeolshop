                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6 class="border p-2 
                                @if ($payment->payment_status == 'cancelled' || $payment->payment_status == 'ditolak')
                                    text-danger
                                ...
                                <form action="{{ route('AdminPayment.update', $payment->id) }}" method="post">
                                    ...
                                    <div class="input-group">
                                        <select name="payment_status" id="" class="form-select">
                                            ...
                                            <option class="text-capitalize" {{ $payment->payment_status == 'belum di verifikasi' ? 'selected': '' }} value="belum di verifikasi">belum di verifikasi</option>
                                            <option class="text-capitalize" {{ $payment->payment_status == 'terverifikasi' ? 'selected': '' }} value="terverifikasi">terverifikasi</option>
                                            <option class="text-capitalize" {{ $payment->payment_status == 'ditolak' ? 'selected': '' }} value="ditolak">ditolak</option>
                                        </select>
